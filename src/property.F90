...
module musica_property
  ...
  contains
    ...
    final :: property_ptr_finalize, property_ptr_finalize_1D
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !> Finalize a 1D array of property_ptr objects
  subroutine property_ptr_finalize_1D( this )
    ...
    do i_prop = 1, size( this )
      if( associated( this( i_prop )%val_ ) ) then
        deallocate( this( i_prop )%val_ )
        this( i_prop )%val_ => null( )
      end if
    end do

  end subroutine property_ptr_finalize_1D
