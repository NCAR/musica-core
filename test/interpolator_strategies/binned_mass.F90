...
!
!> \file
!> Tests for the musica_interpolator_binned_mass module

!> Test module for the binned-mass interpolator strategy
program test_interpolator_binned_mass
...
#endif
  !$omp parallel
  call test_binned_mass_strategy( )
  !$omp end parallel
  call example( )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine test_binned_mass_strategy( )

    use musica_assert,                 only : assert
    use musica_constants,              only : musica_dk
    use musica_grid,                   only : grid_t
    use musica_interpolator,           only : interpolator_t
    use musica_interpolator_binned_mass, only : strategy
  ...
  end subroutine test_binned_mass_strategy
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine example( )
    ...
    !! [Binned-mass interpolator example]
    use musica_constants,              only : musica_dk
    use musica_grid,                   only : grid_t
    use musica_interpolator,           only : interpolator_t
    use musica_interpolator_binned_mass, only : strategy
...
end program test_interpolator_binned_mass
